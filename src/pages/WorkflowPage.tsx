...
const WorkflowPage = () => {
  ...
  return <div className="h-full flex">
      ...
      {showNodePalette && <div className="w-64 border-r border-border/30 bg-background overflow-auto flex flex-col">
          
          <div className="flex-1 overflow-auto">
            <NodePalette />
          </div>
          <div className="p-4 border-t border-border/30">
            <Button variant="outline" className="w-full flex items-center gap-2 justify-start" onClick={() => console.log("Settings clicked")}>
