...
export const WorkflowProvider: React.FC<{ children: React.ReactNode }> = ({
    ...
    const refreshWorkflows = async () => {
        ...
        try {
            const fetchedWorkflows = await fetchWorkflowsForAccount(
                accountId,
                useFallback
            );
...
export const useWorkflowContext = () => {
    throw new Error(
        'This context is deprecated. Use useWorkflowContext from contexts/workflow/WorkflowProvider instead'
    );
};
