...
const Features = () => {
    const features = [
        ...
        },
        {
            ...
            content:
                "Seamless integration with all the MCP servers you're already using"
        },
        {
            icon: Workflow,
        ...
        // High Performance feature removed temporarily
        {
            ...
            content:
                'Seamlessly integrate existing API infrastructure with modern AI agents, creating powerful hybrid solutions without rewriting your systems.'
        },
        {
            icon: Code,
            title: 'Open Source',
