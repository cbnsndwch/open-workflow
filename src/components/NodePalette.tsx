...
import { RectangleHorizontal, GitBranch, LayoutTemplate, Combine, Check, X } from 'lucide-react';
...
const NodePalette: React.FC<NodePaletteProps> = ({ open = false, onSelect, onClose }) => {
    ...
    <Sheet open={open} onOpenChange={(isOpen) => !isOpen && onClose?.()}>
      <SheetContent side="right" className="w-80 p-0 border-l">
        <SheetHeader className="px-4 py-2 border-b border-border/30">
          <SheetTitle className="text-left text-lg">Add Node</SheetTitle>
